...
files_names_notme = os.listdir('C:/Users/jairm/OneDrive/Documentos/Repositorios/Reconocimiento_facial/Project/data/base_fotos_propias')
for files_names in files_names_notme:
    files_names_me = [f'{files_names}']

    #files_names_me = ['pendiente37.jpeg']
    attributes_me = [0]
    ...
    for image, attri in save.take(1):
        plt.imshow(image)
        plt.show()
