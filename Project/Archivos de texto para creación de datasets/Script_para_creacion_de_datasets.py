...
print(labeled_images_me.__len__()) #Tamaño del dataset es 6642
print(concat_ds.__len__()) #Tamaño del dataset es la suma de los dos anteriores, es decir, 11642.
...
train_ds, val_ds, test_ds = get_dataset_partitions_tf(concat_ds, 11642)
print(type(train_ds))
